...
class TaskAssignment(models.Model):
    ...
    organisation=models.ForeignKey(Oganisation,on_delete=models.CASCADE,related_name="tasks",null=True,blank=True)
    ...
    team_lead_replay_note=models.TextField(null=True,blank=True)
    ...
    def __str__(self):
        return f"{self.title} -{self.employee.user.employee_id} assine to {self.employee.user.name}-----{self.id}"